...
barplot(table(crime$Area.Name[crime$Arrest.Type.Code=="I"]), horiz = TRUE, las = 1, col=rainbow(length(unique(crime$Area.Name))), main="Infractions by Area")

barplot(table(crime$Area.Name[crime$Arrest.Type.Code=="M"]), horiz = TRUE, las = 1, col=rainbow(length(unique(crime$Area.Name))), main="Misdemeanor by Area")

barplot(table(crime$Area.Name[crime$Arrest.Type.Code=="F"]), horiz = TRUE, las = 1, col=rainbow(length(unique(crime$Area.Name))), main="Felony by Area")
